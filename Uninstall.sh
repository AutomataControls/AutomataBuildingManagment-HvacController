...
# Step 1: Start the Tkinter GUI for uninstallation before starting any process
echo "Starting uninstallation GUI..."
python3 /home/Automata/AutomataBuildingManagment-HvacController/uninstall_progress_gui.py &

# Get the process ID of the GUI
GUI_PID=$!

# Step 2: Stop and remove Mosquitto service and user credentials
...
# Step 3: Restore the default swap size (typically 100 MB)
...
# Step 4: Remove Node-RED and related services
...
# Step 5: Remove Sequent Microsystems drivers (Skip errors)
...
# Step 6: Disable I2C, SPI, VNC, 1-Wire, Remote GPIO, and SSH; re-enable the serial port
...
# Step 7: Remove the desktop icon for Node-RED
...
# Step 8: Remove the cloned repository directory
...
# Step 9: Close the GUI after uninstallation is complete
kill $GUI_PID
