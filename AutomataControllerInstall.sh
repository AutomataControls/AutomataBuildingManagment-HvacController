...
def run_installation_steps():
    ...
    # Step 4: Install Node-RED and its palettes
    ...
    run_shell_command("sudo apt-get install -y mosquitto mosquitto-clients && sudo mosquitto_passwd -b /etc/mosquitto/passwd Automata Inverted2", 8, total_steps, "Installing Mosquitto...")
    ...
    # Step 10: Add temporary auto-start entry for update_sequent_boards.sh and prepare first reboot
    run_shell_command("echo '@/home/Automata/update_sequent_boards.sh' >> /home/Automata/.config/lxsession/LXDE-pi/autostart", 10, total_steps, "Adding board update auto-start...")
