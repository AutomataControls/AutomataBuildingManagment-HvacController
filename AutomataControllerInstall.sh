...
# Step 1: Install Zenity for dialog boxes
echo "Installing Zenity..."
sudo apt-get install -y zenity

# Step 2: Cleanup previous installation attempts and stop services
...
sudo apt-get update
sudo apt-get install -y feh  # Required for setting wallpaper
echo "Dependencies installed."

# Step 4: Set executable permissions for all files in the cloned repository
...
# Step 5: Set system clock to local internet time and correct timezone
...
# Step 6: Set FullLogo.png as desktop wallpaper and splash screen as the 'Automata' user
...
# Step 7: Change the desktop background to FullLogo.png
...
# Step 10: Increase the swap size to 2048 MB
echo "Increasing swap size..."
run_script "increase_swap_size.sh"
echo "Swap size increased."

# Step 11: Install Node-RED non-interactively and prevent prompts
...
# Step 12: Run SequentMSInstall.sh to install Sequent Microsystems drivers
...
# Step 13: Add post-reboot process for killing services and updating Sequent boards
